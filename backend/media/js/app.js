...
var App = function () {
    ...
    var handleSidebarToggler = function () {
        ...
        $('.page-sidebar').on('keypress', '.sidebar-search input', function (e) {
            if (e.which == 13) {
                //var word = document.getElementByName('backend_search');
                var word1 = "test";
                //var word2 = $_POST['backend_search'];
                window.location.href = "extra_search.php?id="+word1;
    ...
    var handleHorizontalMenu = function () {
        ...
        $('.header').on('click', '.hor-menu .search-form .btn', function (e) {
                window.location.href = "extra_search.php";
                e.preventDefault();
            });
