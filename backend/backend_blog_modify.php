...
//$sql="update articles set title='$_POST[modify_title]' where sname='pu'";  
		...
		<div class="page-sidebar nav-collapse collapse">
			...
			<ul class="page-sidebar-menu">
				...
				<li>
                    ...
                    <form class="sidebar-search" id="backend_search" role="form" action="search_test.php" method="post">

						<div class="input-box">

							<!--<a href="javascript:;" class="remove"></a>-->

							<input type="text" id="backend_search" name="backend_search" placeholder="Search..." />
				...
				<!-- END PAGE HEADER-->
						...
						<!-- BEGIN EXTRAS PORTLET-->
                			...
                			<div class="page-content">
									...
									<form role="form" action="modify.php?id=<?php echo $id ?>" method="post">

										<label>Title</label>

										<input type="text" name="modify_title" class="span7 m-wrap" value="<?php echo $row['title'] ?>" >

                                        <label>ID</label>

										<input type="text" name="modify_id" class="span7 m-wrap" value="<?php echo $id ?>">
										...
										<textarea class="span10 m-wrap" rows="8" name="modify_content" ><?php echo $row['content'] ?></textarea>

										<p><button class="btn blue" action="modify.php"  type="submit">Submit</button></p>
