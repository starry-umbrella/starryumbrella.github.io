...
<head>
	...
	<title>Starry Umbrella | Innovation</title>
					...
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li>
								...
								<a href="backend_blog_modify.php?id=<?php  echo $row['id'] ?>"><?php	echo $row['title'] ?></a> 
						...
						<div class="row-fluid">
							...
							<div class="span9 article-block">
								...
								<div class="media">
									...
									<img alt="" src="media/image/user4.jpg" class="media-object">

									</a>

									<div class="media-body">

										<h4 class="media-heading">User4 <span>2 days ago / <a href="#">Reply</a></span></h4>
										...
										<div class="media">
											...
											<img alt="" src="media/image/user5.jpg" class="media-object">

											</a>

											<div class="media-body">

												<h4 class="media-heading">User5 <span>2 days ago / <a href="#">Reply</a></span></h4>
